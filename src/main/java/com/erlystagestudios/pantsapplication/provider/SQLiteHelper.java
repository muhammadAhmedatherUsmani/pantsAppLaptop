...
public class SQLiteHelper {
	 ...
	 */
	public SQLiteHelper (Context context, String name, String storageDirectory, CursorFactory factory,
						 int version) {
		...
		mUpgradePathFormat = "upgrade_%s-%s_" + name;
	}
	 ...
	 */
	public synchronized SQLiteDatabase getWritableDatabase (SQLiteOpenHelper helper) {
	 ...
	 */
	public synchronized SQLiteDatabase getReadableDatabase (SQLiteOpenHelper helper) {
		...
		try {
			return getWritableDatabase( helper );
		}
